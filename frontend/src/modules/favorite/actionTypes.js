export const FIND_FAVORITES_COMPLETED = "/project/products/findFavoritesCompleted";
...
export const UNMARK_AS_FAVORITE_COMPLETED = "/project/products/unmarkAsFavoriteCompleted";